...
function  [7:0] mul2;
    input [7:0] in_byte;
    begin
        mul2 = in_byte[7]? (in_byte << 1)^8'h1b : (in_byte << 1) & 8'hff;
    end
endfunction 
...
function [ 7:0] rcon_lookup;
    ...
    begin
        ...
        rcon[5]=8'h10; rcon[6]=8'h20; rcon[7]=8'h40;
        rcon[8]=8'h80; rcon[9]=8'h1b; rcon[10]=8'h36;
        rcon_lookup = rcon[count];
    end
endfunction
...
function [32:0] gfunc;    
    ...
    begin
        ...
        rcon_byte = rcon_lookup(count);
        gfunc = {1'b1, sbox_word[31:24]^rcon_byte, sbox_word[23:0]};
    end
endfunction
